...
class ConstantColors {
  static const bgColor = Color(0xFFFDFCFC);
  ...
  static const Color dark = Color(0xFF0623E0);
  static const Color medium = Color(0xFF4196F8);
  static const Color light = Color(0xFFEBF8FF);
  static const Color lightest = Color(0xFFD0EEFF);
